...
#endif
#define RX1_BUFFER_SIZE         1700 /* 512 */
...
#define IS_CAP_DBDC(_pAd) 	(_pAd->chipCap.asic_caps & fASIC_CAP_DBDC)

#define IS_CAP_BW160(_pAd) 	((_pAd->chipCap.phy_caps & (fPHY_CAP_BW160NC | fPHY_CAP_BW160C)) != 0)
...
#define MAX_LEN_OF_SUPPORTED_CHL        32
...
#define SET_ENTRY_STATE_INUSE(_x)      ((_x)->EntryState = ENTRY_STATE_INUSE)
#define SET_ENTRY_STATE_IDLE(_x)      ((_x)->EntryState = ENTRY_STATE_IDLE)
#define GET_ENTRY_STATE(_x)       ((_x)->EntryState)
